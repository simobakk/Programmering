...
if __name__ == '__main__':
    ...
    dataset_dir = os.path.join("C:\\Users\\simon\\OneDrive - Norwegian University of Life Sciences\\Documents\\Masteroppgave v24\\Programmering\\måledata", 'MERRA2_data', '2018-1-1~2018-1-3 rad-slv-aer-asm [-90,-180]~[90,180]', '')
